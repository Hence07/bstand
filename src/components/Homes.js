    ...
    return (
      ...
      <Navbar dark sticky="top" expand="md">
          <div className="container">
                <NavbarBrand className="mr-auto" href="/"><img src="./Images/bs0.png" height="90" width="95" alt="logo" />Business Standard LLC | Business Intelligence</NavbarBrand>
             </div>
    </Navbar>
        <div 
          className="b1"
              ...
              <div class="col" id="col1">
                <h4>About Us</h4>
                  <p>At Business Standard, we’re obsessed with making data the most valuable asset in
                     ...
                     be revolutionized by data. The real innovations will happen when we start to ask “what if”
                  </p>
              </div>
              <div class="col" id="col2">
                ...
                <p>How we experience data is not what it used to be. An effective dashboard is great, but 
                  it’s not the solution to every problem. You want to get more value from your data, do more
                   with your data, and enable others to work with data in more ways. </p>
              </div>
            </div>
          </div>
        }
